...
contract TokenFarm is Ownable{
    ...
    // map the staker address to the balance and add this to the token staked (multiple staking tokens)
    ...
    function addAllowedTokens(address _token) onlyOwner public {
